...
| :-------------------------------------- | :------: | :---------------: |
| Baseline (Logistic Regression + TF-IDF) |  0.7964  |      0.8375       |
| (Logistic Regression + HashingTF)       |  0.8208  |      0.8138       |
| (LSTM + Embedding)                      |  0.796   |      0.8375       |
...
LSTM (Improved) đạt kết quả tương đương với baseline, cho thấy mạng nơ-ron có thể học được biểu diễn tốt từ embedding, nhưng chưa vượt trội hơn Logistic Regression trên bộ dữ liệu này. Có thể cần điều chỉnh kiến trúc hoặc huấn luyện lâu hơn để cải thiện.
